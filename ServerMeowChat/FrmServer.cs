    ...
    public partial class FrmServer: Form {
        ...
        private void OnReceive(IAsyncResult ar) {
            ...
            try {
                ...
                if (msgReceived.MessageType != MessageType.Logout && msgReceived.MessageType != MessageType.Disconnect && msgReceived.MessageType != MessageType.AttempLogin && msgReceived.MessageType != MessageType.Regiter) {
